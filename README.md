...
## Development environment and release process
 ...
 - create virtualenv with Flask and issuebot installed into it (latter is installed in
...
install it (`pip install issuebot.tar.gz`), ensure that configuration file exists and
`ISSUEBOT_SETTINGS` environment variable points to it, ensure that user has access to the
